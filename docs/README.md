...
> 📚 **상세한 기술 스택 정보**: [TechStack.md](TechStack.md) 참조
...
- 🛠️ **[TechStack.md](TechStack.md)** - 기술 스택 상세 문서
- ✅ **[task.md](task.md)** - 구현 작업 목록 (10 Phases, 151 Tasks)
- 📊 **[presentation.md](presentation.md)** - 프로젝트 프레젠테이션
- 🎨 **[presentation.pptx.md](presentation.pptx.md)** - Marp 슬라이드
